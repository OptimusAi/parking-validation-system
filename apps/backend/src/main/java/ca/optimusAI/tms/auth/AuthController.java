...
import ca.optimusAI.tms.shared.AuthTokens;
import ca.optimusAI.tms.shared.AuthUser;
import ca.optimusAI.tms.shared.TenantContext;
import ca.optimusAI.tms.shared.TenantInfo;
...
public class AuthController {
    ...
    public ResponseEntity<AuthTokens> login(
        ...
        if (req == null || req.username() == null || req.password() == null) {
            throw new ca.optimusAI.tms.shared.exception.InvalidTokenException(
