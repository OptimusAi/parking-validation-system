package ca.optimusAI.tms.validation.controller;

import ca.optimusAI.tms.shared.PageResponse;
import ca.optimusAI.tms.validation.ValidationService;
import ca.optimusAI.tms.validation.ValidationService.CreateSessionRequest;
